import { ForwarderFactory, ChainID, ReplayProtectionType, RelayHubForwarder } from "../..";
import { Signer } from "ethers";
import { RELAY_HUB_ADDRESS } from "../../deployment/addresses";
import { ForwarderType } from "./forwarderFactory";

export class RelayHubForwarderFactory extends ForwarderFactory<RelayHubForwarder> {
  public constructor() {
