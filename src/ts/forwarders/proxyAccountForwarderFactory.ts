...
export class ProxyAccountForwarderFactory extends ForwarderFactory<ProxyAccountForwarder> {
  public constructor() {
  ...
  public async createNew(
    ...
    const proxyAccountAddress = ProxyAccountForwarder.getAddress(await signer.getAddress());
    ...
    return new ProxyAccountForwarder(
      ...
      signer,
      proxyAccountAddress,
      this.getReplayProtection(signer, proxyAccountAddress, replayProtectionType)
    );
  }
}
