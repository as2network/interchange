...
import { ProxyAccountDeployerFactory, RelayHubFactory, ProxyAccountFactory } from "../../src";
...
describe("Contract addresses", () => {
  ...
  it("RelayHubForwarder", () => {
    checkAddress(VERSION + "|" + RELAY_HUB_SALT_STRING, new RelayHubFactory(), RELAY_HUB_ADDRESS);
  });
