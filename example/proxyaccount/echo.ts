...
(async () => {
  ...
  if (!isProxyDeployed) {
    ...
    console.log("Deploy proxy contract: " + "https://ropsten.etherscan.io/tx/" + proxyTx.hash);
  ...
  const echoAddress = proxyAccount.computeAddressForDeployedContract(initCode, "0x123");
